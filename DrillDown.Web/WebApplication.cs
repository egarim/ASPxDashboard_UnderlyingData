...
namespace DrillDown.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class DrillDownAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private DrillDown.Module.DrillDownModule module3;
        private DrillDown.Module.Web.DrillDownAspNetModule module4;
        ...
        public DrillDownAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void DrillDownAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new DrillDown.Module.Web.DrillDownAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DrillDownAspNetApplication_DatabaseVersionMismatch);
